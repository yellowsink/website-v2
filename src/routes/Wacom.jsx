...
export default () => (
  <>
    ...
    <p class="text-lg">
      A delightful GUI for setting up tablets on Linux, with an equally
      delightful TUI to match.
    </p>
    ...
    <p class="mt-2 font-bold">
      Why work this out manually when I can write a full front-end to xsetwacom
      instead?
    </p>
    ...
    <p>
      .NET 5 SDK is required to build. Runtime dependencies are the xsetwacom
      CLI tool, and MS fonts for the GUI.
    </p>
    <p class="mt-2">
      If you're on Arch, use the AUR package - wacomareax11-git, note that this
      depends on ttf-win10-auto, though.
    </p>
    <p class="mt-2">
    ...
    <p class="mt-2">
      ...
      use <a href="https://opentabletdriver.net/">OpenTabletDriver</a>. (Top
